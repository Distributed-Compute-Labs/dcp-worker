...
Object.assign(exports, {
  ...
  startWorkerLogger(worker, options={}) {
    ...
    worker.on('sandbox', (sandbox) => {
      ...
      /** XXXpfr: @todo Make these event handlers align with current design (June 9, 2022). */
      //sandbox.on('sliceStart', logger.sandbox$onSliceStart.bind(logger, sandbox, data));      // Does not exist in sandbox.js.
      ...
      //sandbox.on('slice', logger.sandbox$onSliceFinish.bind(logger, sandbox, data));          // Does not exist in sandbox.js.
