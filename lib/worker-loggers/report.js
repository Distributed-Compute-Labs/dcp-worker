...
const reportLogger = {
  ...
  sandbox$onTerminate(sandbox, sandboxData, ev) {
    console.log('terminate', ev);
    appendToReportFile(`Terminate: ${ev}\n`);
  },
  ...
  sandbox$onWorkerStop(sandbox, sandboxData, ev) {
    console.log('workerStop', ev);
    appendToReportFile(`Worker Stop: ${ev}\n`);
