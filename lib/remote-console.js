 ...
 *              troubleshooting, as an attacker on the network will have the same OS-level
...
exports.init = function remoteConsole$$init(port)
{
  try
  {
    let historyFilename;
    ...
    if (port)
    {
      console.warn('*** Enabling telnet daemon (security risk) ***');
